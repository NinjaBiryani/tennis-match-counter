...
const p1GamePoints = document.getElementById("P1-points"); 
const p2GamePoints = document.getElementById("P2-points"); 
const p1MatchScore = document.getElementById("P1-match-score"); 
const p2MatchScore = document.getElementById("P2-match-score"); 
